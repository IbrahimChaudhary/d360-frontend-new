...
`}
  ...
  `}
        ...
        <div className="absolute bottom-2 md:bottom-4 left-1 right-1 md:left-4 md:right-4 rounded-xl backdrop-blur-sm bg-white/50 px-2 py-1 md:px-4 md:py-3 shadow-md flex flex-col">
